...
# =============================================================================
# 🏛️ БИРЖИ для загрузки 1d свечей
# =============================================================================

# Список бирж, для которых загружаем дневные свечи (1d) по умолчанию
# Если exchange инструмента есть в этом списке → загружаем 1d свечи
EXCHANGES_FOR_1D: Final[list[str]] = [
